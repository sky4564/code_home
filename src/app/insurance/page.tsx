    ...
    <main>
      ...
      <div className="pt-24 pb-16 bg-gradient-to-b from-blue-50 to-white">
        <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
          ...
          {/* 종합보험 보장 안내 */}
          <section className="p-8 mb-12 bg-white rounded-2xl shadow-lg">
            ...
            <div className="p-6 mb-8 bg-blue-50 rounded-xl">
              <p className="leading-relaxed text-gray-700">
                ...
                <span className="font-semibold text-red-600">단, 계약서상 등록되지 않은 운전자의 경우, 종합보험 및 자차자손해면책제도의 보험혜택을 받으실 수 없습니다.</span>
              </p>
            </div>

            <div className="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-4">
              <div className="p-6 text-white bg-gradient-to-br from-blue-500 to-blue-600 rounded-xl shadow-md">
                <h3 className="mb-2 text-lg font-semibold">대인</h3>
                <p className="text-3xl font-bold">무한</p>
              </div>
              <div className="p-6 text-white bg-gradient-to-br from-green-500 to-green-600 rounded-xl shadow-md">
                <h3 className="mb-2 text-lg font-semibold">대물</h3>
                <p className="text-3xl font-bold">3천만원</p>
                <p className="text-sm opacity-90">최대</p>
              </div>
              <div className="p-6 text-white bg-gradient-to-br from-purple-500 to-purple-600 rounded-xl shadow-md">
                <h3 className="mb-2 text-lg font-semibold">자손</h3>
                <p className="text-3xl font-bold">1천5백만원</p>
                <p className="text-sm opacity-90">최대</p>
              </div>
              <div className="p-6 text-white bg-gradient-to-br from-orange-500 to-orange-600 rounded-xl shadow-md">
                <h3 className="mb-2 text-lg font-semibold">자차</h3>
          ...
          <section className="p-8 mb-12 bg-white rounded-2xl shadow-lg">
            ...
            <div className="grid grid-cols-2 gap-4 mb-6 md:grid-cols-4">
              <div className="p-4 text-center bg-gray-50 rounded-lg border-2 border-gray-200">
                <h3 className="mb-2 text-sm font-semibold text-gray-600">대인</h3>
                <p className="text-2xl font-bold text-gray-900">50만원</p>
              </div>
              <div className="p-4 text-center bg-gray-50 rounded-lg border-2 border-gray-200">
                <h3 className="mb-2 text-sm font-semibold text-gray-600">대물</h3>
                <p className="text-2xl font-bold text-gray-900">50만원</p>
              </div>
              <div className="p-4 text-center bg-gray-50 rounded-lg border-2 border-gray-200">
                <h3 className="mb-2 text-sm font-semibold text-gray-600">자손</h3>
                <p className="text-2xl font-bold text-gray-900">50만원</p>
              </div>
              <div className="p-4 text-center bg-gray-50 rounded-lg border-2 border-gray-200">
                <h3 className="mb-2 text-sm font-semibold text-gray-600">자차</h3>
                <p className="text-2xl font-bold text-gray-900">50만원</p>
              </div>
            </div>
          ...
          <section className="p-8 bg-white rounded-2xl shadow-lg">
            ...
            <div className="p-6 mb-6 bg-red-50 rounded-xl">
              <p className="mb-4 font-semibold text-red-800">다음의 경우 보험 혜택을 받으실 수 없습니다:</p>

              <ul className="space-y-3">
                <li className="flex gap-3 items-start">
                  <span className="flex flex-shrink-0 justify-center items-center w-6 h-6 text-sm font-bold text-white bg-red-600 rounded-full">①</span>
            ...
            {/* 유의사항 */}
            <div className="p-6 space-y-3 bg-gray-50 rounded-xl">
              <h3 className="mb-4 font-bold text-gray-900">유의사항</h3>
              <p className="flex gap-2 items-start text-gray-700">
          ...
          <div className="mt-12 text-center">
            <div className="p-8 text-white bg-gradient-to-r from-blue-600 to-blue-700 rounded-2xl shadow-xl">
              <h3 className="mb-4 text-2xl font-bold">보험 관련 문의사항이 있으신가요?</h3>

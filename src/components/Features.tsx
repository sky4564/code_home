    ...
    <section id="features" className="py-16 bg-white">
      <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
        ...
        <div className="mb-16 text-center">
          <div className="p-8 mb-8 text-white bg-blue-600 rounded-lg">
            <h2 className="mb-4 text-3xl font-bold">카카오톡 ID: charent4275500</h2>
        ...
        <div className="grid grid-cols-1 gap-8 mb-16 lg:grid-cols-3">
          ...
          <div className="p-6 bg-gray-50 rounded-lg">
            ...
            <div className="mb-4">
              <h4 className="mb-2 font-bold text-blue-600">🔵 간선버스</h4>
              <p className="text-gray-700">🚍 6번 / 55번 / 63번 / 303번</p>
            </div>

            <div className="mb-4">
              <h4 className="mb-2 font-bold text-green-600">🟢 지선버스</h4>
              <p className="text-gray-700">🚍 522번 / 523번</p>
            </div>

            <div className="mb-4">
              <h4 className="mb-2 font-bold">📍 정류장 정보</h4>
          ...
          <div className="p-6 bg-gray-50 rounded-lg">
            ...
            <div className="mb-4">
              <h4 className="mb-2 font-bold">🏁 출발지: 인천 1호선 문학경기장역 1번 출구</h4>
            </div>
          ...
          <div className="p-6 bg-gray-50 rounded-lg">
            ...
            <div className="mb-4">
              <h4 className="mb-2 font-bold">🏁 출발지: 인천 1호선 선학역 1번 출구</h4>
            </div>
        ...
        <div className="grid grid-cols-1 gap-8 mb-16 lg:grid-cols-2">
          ...
          <div className="p-6 bg-blue-50 rounded-lg">
            <h3 className="mb-4 text-2xl font-bold">🚗 차렌터카 주차 안내 - 편리한 주차 + 렌터카 서비스</h3>
            ...
            <div className="mb-4">
              <h4 className="mb-2 font-bold text-green-600">✅ 이용 방법</h4>
            ...
            <div className="mb-4">
              <h4 className="mb-2 font-bold text-blue-600">💡 차렌터카만의 장점</h4>
              <div className="space-y-1 text-sm text-gray-700">
                <p>• 넉넉한 주차 공간 완비 🅿️</p>
          ...
          <div className="p-6 bg-green-50 rounded-lg">
            <h3 className="mb-4 text-2xl font-bold">🚻 차렌터카 고객 편의시설 안내</h3>
            ...
            <div className="mb-4">
              <h4 className="mb-2 font-bold text-blue-600">✅ 깨끗한 남녀 전용 화장실 완비</h4>
              <div className="space-y-1 text-sm text-gray-700">
            ...
            <div className="mb-4">
              <h4 className="mb-2 font-bold text-green-600">💡 이런 분들께 유용합니다.</h4>
              <div className="space-y-1 text-sm text-gray-700">
        ...
        <div className="p-8 text-center text-white bg-gray-800 rounded-lg">
          <h3 className="mb-4 text-2xl font-bold">고객센터</h3>
          <h2 className="mb-4 text-4xl font-bold text-blue-400">032-427-5500</h2>
